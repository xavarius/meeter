...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(view -> Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG).setAction("Action", null).show());
    ...
    private void buildSignInGoogle() {
        ...
        mGoogleAPI = new GoogleApiClient.Builder(this)
                .enableAutoManage(this , view -> Toast.makeText(this, "sign in fuck up", Toast.LENGTH_SHORT).show())
    ...
    private void handleGoogleSignInResult(@NonNull final Intent result) {
        final GoogleSignInResult googleSignInResult = Auth.GoogleSignInApi.getSignInResultFromIntent(result);
